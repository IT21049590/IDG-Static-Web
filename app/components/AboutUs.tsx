    ...
    return (
        <div className="py-20 w-full" id="about">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 mt-10">
                <Card>
                    <img src="/IDG-Static-Web/NuwanSir.JPG" alt="Team Member" width="250" height="200" />
                    <div className="p-4">
                ...
                <Card>
                    ...
                    <img src="/IDG-Static-Web/JennyMiss.JPG" alt="Team Member" width="250" height="200" />
                    <div className="p-4">
                ...
                <Card>
                    <img src="/IDG-Static-Web/Hiruna.JPG" alt="Team Member" width="250" height="200" />
                    <div className="p-4">
                ...
                <Card>
                    <img src="/IDG-Static-Web/Ravishka.JPG" alt="Team Member" width="250" height="200" />
                    <div className="p-4">
                ...
                <Card>
                    <img src="/IDG-Static-Web/Maneesha.JPG" alt="Team Member" width="250" height="200" />
                    <div className="p-4">
                ...
                <Card>
                    <img src="/IDG-Static-Web/Pravini.jpg" alt="Team Member" width="250" height="200" />
                    <div className="p-4">
